...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        verificaCarro(motorista, placa, cor);
    ...
    public void verificaCarro(Motorista motorista, String placa, Cor cor) {
            ...
            if (motorista == null) {
                throw new EstacionamentoException("O carro não pode ser autônomo.");
            }
    }
